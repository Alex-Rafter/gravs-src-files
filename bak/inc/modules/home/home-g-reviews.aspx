  ...
  <div class="container">
    <div class="row">
      ...
      <div class="order-lg-1 col-12 col-lg-5 ms-lg-auto">
        <img
          src="/img/g-reviews/smiling-dudejpg"
          alt="smiling dude"
      ...
      <div class="col-12 col-lg-5 offset-lg-1">
        <div class="g-reviews__copy p-5 p-lg-9 ps-lg-0">
          ...
          <blockquote class="g-reviews__reviewer h6 mb-1">
            Alan Owen, Gravells Kia Kidwelly
          </blockquote>
          <p class="g-reviews__date text-grey">0701.22</p>
        </div>
      </div>
      <!-- Col Two -->
