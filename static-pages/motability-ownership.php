...
<body>
    ...
    <main class="main overflow-hidden bg-light" id="main">
        ...
        <!-- CONTENT AREA -->
        <?php $heroTitleCMS = "Motability Ownership"; $heroImageCMS = "/img/motability/motab-hero-1.png"; ?>
        <?php include('/src-test/inc/modules/cms-pages/cms-page-hero.php'); ?>
        <?php include('/src-test/inc/modules/cms-pages/cms-page-content-motab.php'); ?>
        <!-- CONTENT AREA -->
